...
**已注册可玩模块**以 `go run ./cmd/officialgames` 输出为准；当前包含 Air Rally、Blue Bear、Bouncy Road、Cheer Readers、Kitties!、Lockstep、Marching Orders、Meat Grinder、Munchy Monk、Rhythm Sōmen、See-Saw、Sneaky Spirits、Space Dance、Tambourine、Tap Trial、Totem Climb、Trick on the Class（karateman 仍走旧 demo 路径）。
