...
var officialBaseSceneSpecs = map[string]sceneSpec{
	...
	"chargingChicken": {
		dir:    "ChargingChicken",
		prefab: "chargingChicken.prefab",
		roleFields: []string{
			"gradient", "bgLow", "bgHigh", "ChickenAnim", "WaterAnim",
			"ParallaxFade", "UnParallaxFade", "BirdsAnim",
			"Stars", "Clouds", "Planets", "Doodles", "Birds",
			"yardsText", "endingText", "bubbleText", "countBubble",
			"Helmet", "FallingHelmet", "headlightColor",
		},
		wantControllers: true,
		components: []componentSpec{
			{name: "game", markers: []string{
				...
				"Stars", "Clouds", "Planets", "Doodles", "Birds",
				"yardsText", "endingText", "bubbleText", "countBubble",
				"Helmet", "FallingHelmet", "chickenColors", "chickenColorsCar",
				"chickenColorsCloud", "chickenColorsDoodles", "chickenColorsWater",
				"headlightColor", "IslandBase",
			}},
			{name: "island", markers: []string{
				"ChargerAnim", "FakeChickenAnim", "PlatformAnim", "IslandPos",
				"CollapsedLandmass", "BigLandmass", "SmallLandmass", "FullLandmass",
				"Helmet", "StoneSplashEffect", "IslandCollapse", "IslandCollapseNg",
				"ChickenSplashEffect", "GrassL", "GrassR", "PlatformBase",
			}, atPath: "Island"},
		},
	},
	...
	"loveLab": {
		dir:    "LoveLab",
		prefab: "loveLab.prefab",
		roleFields: []string{
			"labGuy", "labGuyHead", "labGuyArm", "labGirl", "labGirlHead", "labGirlArm",
			"labAssistant", "labAssistantHead", "labAssistantArm",
			"flask", "labFlaskObj", "labGirlFlaskObj", "boyFlaskBreak", "girlFlaskBreak",
			"flaskSpriteRend", "girlFlaskSpriteRend", "weirdFlaskSpriteRend",
			"heartBox", "spotlightShader", "spotlightShaderCone", "spotlightCone",
			"labHeartBox", "boxPerson", "boxPersonDay", "heartContainer",
			"labGuyFlask", "labGirlFlask", "clouds", "sunsetBG", "dayBG",
			"girlHeaderShader", "boyHeaderShader", "weirdHeaderShader",
			"heartHolder", "guyHeartObj", "girlHeartObj", "completeHeartObj", "endPoint",
		},
		strArrayFields: []string{"flaskArcToBoy", "flaskArcToGirl"},
		templatePrefabs: []string{
			"Prefabs/Flask.prefab",
			"Prefabs/GirlFlask.prefab",
			"Prefabs/Hearts.prefab",
			"Prefabs/GirlHearts.prefab",
			"Prefabs/CompleteHearts.prefab",
			"Prefabs/BoyFlaskBreak.prefab",
			"Prefabs/GirlFlaskBreak.prefab",
		},
		wantControllers: true,
		...
		components: []componentSpec{
			{name: "game", markers: []string{
				...
				"labAssistant", "labAssistantHead", "labAssistantArm",
				"flask", "labFlaskObj", "labGirlFlaskObj", "boyFlaskBreak", "girlFlaskBreak",
				"flaskMatForBoy", "flaskMatForGirl", "flaskMatForWeird",
				"boyLiquidColor", "girlLiquidColor", "weirdLiquidColor",
				"flaskSpriteRend", "girlFlaskSpriteRend", "weirdFlaskSpriteRend",
				"flaskArcToBoy", "flaskArcToGirl", "heartBox", "spotlightShader",
				"spotlightShaderCone", "spotlightCone", "labHeartBox", "boxPerson",
				"boxPersonDay", "heartContainer", "labGuyFlask", "labGirlFlask",
				"clouds", "cloudSpeed", "cloudDistance", "sunsetBG", "dayBG",
				"girlShader", "girlHeaderShader", "boyShader", "boyHeaderShader",
				"weirdShader", "weirdHeaderShader", "speedForHearts",
				"speedForHeartsMultiplier", "speedForHeartsMinimizer",
				"heartHolder", "guyHeartObj", "girlHeartObj", "completeHeartObj",
				"endPoint", "spawnPoint", "flaskBouncePath",
			}},
			{name: "heart0", markers: []string{
				"whatHeartType", "heartAnim", "death", "outline", "fill",
			}, atPath: "Hearts"},
			{name: "heart1", markers: []string{
				"whatHeartType", "heartAnim", "death", "outline", "fill",
			}, atPath: "GirlHearts"},
			{name: "heart2", markers: []string{
				"whatHeartType", "heartAnim", "death", "outline", "fill",
			}, atPath: "CompleteHearts"},
		},
	},
	...
	"rhythmRally": {
		dir:        "RhythmRally",
		prefab:     "rhythmRally.prefab",
		spritesDir: "Models/materials",
		animsDir:   "Models",
		roleFields: []string{
			"cameraPivot", "cameraPos",
			"ball", "ballShadow", "ballTrail",
			"serveCurve", "returnCurve", "tossCurve", "missCurve", "ballHitFX",
			"playerAnim", "opponentAnim",
			"BG", "WBG", "Lights", "paddlers",
		},
		curveFields:     []string{"serveCurve", "returnCurve", "tossCurve", "missCurve"},
		wantControllers: true,
		commonSounds:    []string{"miss.wav"},
		components: []componentSpec{
			{name: "game", markers: []string{
				"cameraPivot", "cameraPos", "cameraFOV",
				"ball", "ballShadow", "ballTrail", "serveCurve", "returnCurve", "tossCurve", "missCurve", "ballHitFX",
				"playerAnim", "opponentAnim", "rallySpeed", "started", "missed", "served", "tossing",
				"serveBeat", "targetBeat", "tossBeat", "missBeat", "tossLength",
				"BG", "WBG", "Lights", "paddlers", "voidMat",
			}, curveFields: []string{"serveCurve", "returnCurve", "tossCurve", "missCurve"}},
		},
	},
	...
	"superSamuraiSlice": {
		dir:    "SuperSamuraiSlice",
		prefab: "superSamuraiSlice.prefab",
		roleFields: []string{
			"SamuraiShadow", "Samurai", "BG", "Water", "waterGO",
			"FG", "Fog", "fogGO", "Cloud", "flash",
			"Skateboard", "Eagle", "BGAnim", "CloudAnim",
			"Samurai1Anim", "Skateboard1Anim", "Eagle1Anim",
			"SamuraiAnim", "SkateboardAnim", "EagleAnim",
			"lightning", "waterL", "waterR", "SmallDemon", "MediumDemon",
		},
		roleFallbacks: map[string]string{
			"SmallDemon":  "demon",
		...
		wantControllers: true,
		templatePrefabs: []string{
			"Prefabs/demon.prefab",
			"Prefabs/mediumDemon.prefab",
		},
		components: []componentSpec{
			{name: "game", markers: []string{
				"SamuraiShadow", "Samurai", "BG", "Water", "waterGO",
			...
			{name: "demon", markers: []string{
				"SmallDemonAnim", "MediumDemonAnim", "windZone",
				"groundPlane", "Explode1", "Explode2", "Explode3",
			}, multi: true},
		},
	},
